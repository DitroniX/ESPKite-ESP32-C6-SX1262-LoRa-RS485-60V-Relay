...
// **************** INPUTS ****************
#define User_GP15 15  // External Input
...
void setup() {
  ...
  pinMode(User_GP15, INPUT_PULLDOWN);

  Serial.println("ESPKite Bring Up and Test Example Code");
  Serial.println("Ready for GP15 Input");
}
...
void loop() {
  ...
  if (digitalRead(User_GP15) == HIGH) {

    Serial.println("User User_GP15");
