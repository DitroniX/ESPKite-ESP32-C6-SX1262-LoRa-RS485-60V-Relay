/*
  ...
  .
  This test csode is OPEN SOURCE and formatted for easier viewing.  Although is is not intended for real world use, it may be freely used, or modified as needed.
...
// ESPKite Pin Matrix https://github.com/DitroniX/ESPKite-ESP32-C6-SX1262-LoRa-RS485-60V-Relay/wiki/Pin-Matrix

/*
  ESP32-C6 Default Factory Serial Port Initialized
  MOSI: 22
  MISO: 23
  SCL / SCLK: 21
  CS / SS: 0
